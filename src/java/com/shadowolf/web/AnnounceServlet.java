...
public class AnnounceServlet extends HttpServlet {
	...
	public void init(ServletConfig servletConfig) throws ServletException {
		...
		Object executor = context.getAttribute("scheduledThreadPoolExecutor");
		Object infoHashCache = context.getAttribute("infoHashCache");

		this.config = (Config)config;
		this.executor = (ScheduledThreadPoolExecutor)executor;
	...
	public void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Registry.getClient(announce.getClientIdentifier()).updateStats(torrentId, announce.getUploaded(), announce.getDownloaded());
